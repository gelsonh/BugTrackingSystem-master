...
namespace BugTrackingSystem.Data
{
    public static class DataUtility
    {
        ...
        public static async Task SeedDefaultTicketsAsync(ApplicationDbContext context, UserManager<BTUser> userManager)
        {
            ...
            int statusNew = context.TicketStatus.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.New))!.Id;
            int statusDev = context.TicketStatus.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.Development))!.Id;
            int statusTest = context.TicketStatus.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.Testing))!.Id;
            int statusResolved = context.TicketStatus.FirstOrDefault(p => p.Name == nameof(BTTicketStatuses.Resolved))!.Id;
