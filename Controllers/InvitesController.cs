...
namespace BugTrackingSystem.Controllers
{
    ...
    public class InvitesController : Controller
    {
        ...
        public InvitesController(ApplicationDbContext context, IBTProjectService projectService, IDataProtectionProvider dataProtectionProvider, IBTCompanyService companyService, IEmailSender emailSender, UserManager<BTUser> userManager, IBTInviteService inviteService, IConfiguration configuration)
        {
            _context = context;
            _projectService = projectService;
            _protector = dataProtectionProvider.CreateProtector(configuration["ProtectKey"]!);
